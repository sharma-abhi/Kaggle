...
```
Accuracy: 0.78469
We find that the above model results in an accuracy of 0.78469 in Kaggle.
...
```
Decision Tree scored 0.77033, close to the RF model but not better.
...
```
Ensemble scored 0.78469, which is exactly the score Rf gave us, not surprising 
